...
def divGradfs(u::Array{Float64,1},s::Array{Float64,1})
...
def tangent_step(v0::Array{Float64,1},u::Array{Float64,1},
					 s::Array{Float64,1},
					 ds::Array{Float64,1})
...
def adjoint_step(y1::Array{Float64,1},u::Array{Float64,1},
					 s::Array{Float64,1},
					 dJ::Array{Float64,1})
